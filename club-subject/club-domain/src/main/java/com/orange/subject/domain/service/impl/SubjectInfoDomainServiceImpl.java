...
import com.orange.subject.infra.basic.entity.*;
import com.orange.subject.infra.basic.service.*;
...
//        log.info("subjectInfoList:{}",JSON.toJSONString(subjectInfoList));
...
//        log.info("subjectInfoBOS:{}",JSON.toJSONString(subjectInfoBOS));
